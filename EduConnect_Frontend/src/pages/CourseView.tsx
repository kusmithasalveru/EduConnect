                ...
                <div className="grid grid-cols-3 gap-6">
                    ...
                    <div className="col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <button className="mt-6 w-full py-3 border-2 border-accent-600 text-accent-600 rounded-lg font-semibold hover:bg-accent-50 dark:hover:bg-accent-900 transition-colors">
                                Start a Discussion
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-sm border border-gray-200 dark:border-slate-700 sticky top-24">
                            ...
                            <div className="p-6">
                                ...
                                <button className="w-full mt-6 py-2 border border-gray-300 dark:border-slate-700 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors font-semibold text-sm">
